...
<div class="relative border-b border-neutral-200 p-8 pb-8 xl:flex-1 dark:border-neutral-700">
	<h1 class="mb-10 text-6xl font-semibold lg:text-7xl">Hey, I'm Amadu Swaray 👋</h1>
	<Connect />
</div>
<div
...
>
	<p class="mb-6 text-lg">
		I'm a developer based in Norway with a passion for all things technology — from software and CLI
		tools to consumer-focused innovations.
	</p>

	<section class="mb-8">
		<h2 class="mb-2 text-2xl font-semibold">Developer Life</h2>
		<p class="mb-2">
			I’m an avid <span class="font-medium text-indigo-600 dark:text-pink-300">Vim</span> user and enjoy
			crafting custom configurations to boost my workflow. Over time, I’ve gravitated away from traditional
			desktop and mobile apps, preferring to accomplish tasks directly in the terminal.
		</p>
	</section>
	...
	<section class="mb-8">
		...
		<p class="mb-2">
			...
			and
			<span class="font-medium text-indigo-600 dark:text-pink-300">Swift</span>.
		</p>
	</section>
